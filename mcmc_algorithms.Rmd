...
```{r fig7, echo=F, fig.height = 4.5, fig.width = 7, fig.cap = 'Scatterplot of samples comparing Metropolis and Gibbs algorithms. Inspired by Figure 7.6 in Kruschke, J.K. (2015). \\textit{Doing Bayesian Data Analysis in R: A Tutorial with R, JAGS, and Stan}. 2nd Edition. Academic Press/Elsiver.'}
opar <- par()
cex <- 1.0 #size of points on plot
cex.main <- 1.1 #size of title
cex.lab <- 1.1 #size of labels
